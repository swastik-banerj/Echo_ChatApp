        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="m-10 p-3 rounded-2xl bg-gray-700 flex flex-col justify-center">
            <label className="mb-3">
              <Link href={'/chat'} className="text-2xl font-bold">Click here to Chat : {session.user.name}!</Link>
            </label>
          </div>
  ...
  return (
    <div className="bg-gray-800 w-[100%] h-screen flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="m-3">
          <span className="text-3xl">Sign in with Google for better experience</span>
        </div>
